...
let myProgressBar = document.getElementById('vivek');
let gif = document.getElementById('giff');
let masterSongName = document.getElementById('masterSongName');
let songItems = document.getElementsByClassName('songlist');
...
let songs = [
    { songName: "Akele ham akele tum", filePath: "songs/1.mpeg" },
    { songName: "Kore kore sapne mere", filePath: "songs/2.mpeg" },
    { songName: "Dil kehta hai", filePath: "songs/3.mpeg" },
    { songName: "Tip tip barsa pani", filePath: "songs/4.mpeg" },
    { songName: "Aayiye aapka intezaar tha", filePath: "songs/5.mpeg" },
    { songName: "Kabhi khushi kabhi gham", filePath: "songs/6.mpeg" },
